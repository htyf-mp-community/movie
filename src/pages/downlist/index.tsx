    ...
    <View className="pages-downlist-wrap">
      ...
      <View className="pages-downlist-body-wrap">
        <ScrollView
          ...
          <View className="pages-downlist-scroll-body">
            <View className="pages-downlist-book-info-wrap">
              <View className="pages-downlist-book-info-header">
                ...
                <View className="pages-downlist-book-info-right">
                  <View className="pages-downlist-book-info-name-wrap">
                    <Text numberOfLines={1} className="pages-downlist-book-info-name-text">
                      {bookInfo?.name}
                    </Text>
                  </View>
                  <View className="pages-downlist-book-moviedteail-wrap">
                    {bookInfo?.moviedteail_list?.map(item => {
                      ...
                      return (
                        <View
                          key={item.label}
                          className="pages-downlist-book-info-moviedteail-list-wrap">
                          <Text numberOfLines={2} className="pages-downlist-book-moviedteail-text">
              ...
              <View className="pages-downlist-book-info-context-wrap">
                ...
                <View>
                  <Text className="pages-downlist-yp-context">{bookInfo?.yp_context}</Text>
                </View>
              </View>
            </View>
            <View className="pages-downlist-play-list-wrap">
              <View className="pages-downlist-play-list-header">
                <View>
                  <Text className="pages-downlist-box-title">播放列表</Text>
                </View>
              </View>
              <AD />
                  ...
                  return (
                    <View
                      ...
                      className={classNames(
                        'paegs-downlist-play-item-wrap',
                        hisBtn ? 'paegs-downlist-play-item-wrap-on' : '',
                      )}
                      onClick={async () => {
                        dispatch(
                          setHistoryData({
                      ...
                      <View className="paegs-downlist-play-item-name-wrap">
                        <Text
                          numberOfLines={1}
                          className={classNames(
                            'paegs-downlist-play-item-name',
                            hisBtn ? 'paegs-downlist-play-item-name-on' : '',
                          )}>
                          {item.name}
                        </Text>
                      </View>
