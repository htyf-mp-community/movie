    ...
    <View className="pages-type-wrap">
            ...
            return (
              <View
                ...
                className={classNames(
                  'pages-type-select-item-btn',
                  on && 'pages-type-select-item-btn-on',
                )}
                onClick={() => {
                  setSearchword(item);
                }}>
                <Text
                  className={classNames(
                    'pages-type-select-item-text',
                    on && 'pages-type-select-item-text-on',
                  )}>
                  {TypeEnum[item]}
                </Text>
              </View>
      ...
      <View className="pages-type-body-wrap">
        <ScrollView
          ...
          <AD />
          <View className="pages-type-scroll-body">
